...
htmlhelp_basename = 'pandas-distinct-doc'
...
latex_documents = [
    (master_doc, 'pandas-distinct.tex', 'pandas-distinct Documentation',
     'COM', 'manual'),
]
...
man_pages = [
    (master_doc, 'pandas-distinct', 'pandas-distinct Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pandas-distinct', 'pandas-distinct Documentation',
     author, 'pandas-distinct', 'One line description of project.',
     'Miscellaneous'),
]
